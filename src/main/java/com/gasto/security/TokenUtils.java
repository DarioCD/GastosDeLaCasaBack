...
public class TokenUtils {
	...
	private final static String ACCESS_TOKEN_SECRET = "aquivaloqueyoQUIERAAsiQuePongoEsto69";
	// Tiempo de vida del token, 30 dias
	private final static Long ACCESS_TOKEN_VALIDITY_SECONDS = 2_592_000L;

	public static String createToken(String nombre, String email) {
		long expirateTime = ACCESS_TOKEN_VALIDITY_SECONDS * 1_000;
